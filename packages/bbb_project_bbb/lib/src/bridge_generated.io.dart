...
class AaaProjectAaaPlatform extends FlutterRustBridgeBase<AaaProjectAaaWire> {
  AaaProjectAaaPlatform(ffi.DynamicLibrary dylib)
...
class AaaProjectAaaWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  AaaProjectAaaWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  AaaProjectAaaWire.fromLookup(
