...
const String _libName = 'ccc_project_ccc';

/// The dynamic library in which the symbols for [CccProjectCccBindings] can be found.
...
final CccProjectCccBindings _bindings = CccProjectCccBindings(_dylib);
